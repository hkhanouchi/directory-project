...
use FOS\UserBundle\Controller\ResettingController as MasterResettingController;
 ...
 */
class ResettingController extends MasterResettingController
{
    /**
    ...
    public function sendEmailAction(Request $request)
    {
        ...
        return new RedirectResponse($this->generateUrl('app_user_resetting_check_email', array('username' => $username)));
    }
