...
class ClientController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $clients = $em->getRepository('AppBundle:User\\Client')->findAll();
    ...
    {
        $client = new Client();
        $form = $this->createForm('AppBundle\Form\User\ClientType', $client);
    ...
    {
        $deleteForm = $this->createDeleteForm($client);
        $editForm = $this->createForm('AppBundle\Form\User\ClientType', $client);
